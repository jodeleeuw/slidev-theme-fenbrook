...
<template>
  <div class="slidev-layout fenbrook-fact" :class="`align-${align}`">
    <div class="fact-body">
...
.fenbrook-fact.align-center .fact-inner { text-align: center; margin: 0 auto; max-width: 26ch; }
.fenbrook-fact.align-left   .fact-inner { text-align: left;   max-width: 32ch; }
