...
const scrimStyle = computed(() => {
  const tint = props.tint ?? 'var(--fenbrook-bg)'
...
<template>
  <div class="slidev-layout fenbrook-image-bg" :class="[`align-${align}`, `pos-${position}`]">
...
.fenbrook-image-bg.pos-top    .bg-content { justify-content: flex-start; }
.fenbrook-image-bg.pos-center .bg-content { justify-content: center; }
.fenbrook-image-bg.pos-bottom .bg-content { justify-content: flex-end; }

.fenbrook-image-bg.align-center .bg-content { align-items: center; text-align: center; }
.fenbrook-image-bg.align-left   .bg-content { align-items: flex-start; text-align: left; }

.content-inner {
  max-width: 32ch;
}

.fenbrook-image-bg.align-left .content-inner {
  max-width: 36ch;
}
...
.fenbrook-image-bg.align-center .content-inner :deep(p),
.fenbrook-image-bg.align-center .content-inner :deep(h1) {
  margin-left: auto;
  margin-right: auto;
}
</style>
