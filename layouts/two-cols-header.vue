...
<template>
  <div
    class="slidev-layout fenbrook-tch"
    :class="`cols-${cols}`"
    :style="{ '--tch-gap': gap }"
  >
...
.fenbrook-tch.cols-equal      .tch-grid { grid-template-columns: 1fr 1fr; }
.fenbrook-tch.cols-left-wide  .tch-grid { grid-template-columns: 1.5fr 1fr; }
.fenbrook-tch.cols-right-wide .tch-grid { grid-template-columns: 1fr 1.5fr; }
