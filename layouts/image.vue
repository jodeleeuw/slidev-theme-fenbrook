...
<template>
  <div class="slidev-layout fenbrook-image" :class="[{ bleed }, `caption-${captionPosition}`]">
...
.fenbrook-image.bleed .image-wrap img {
  border-radius: 0;
}
...
.image-caption {
  ...
  background: color-mix(in oklab, var(--fenbrook-bg) 70%, transparent);
  border-radius: 4px;
  max-width: 80ch;
  margin: 0 auto;
}
...
.fenbrook-image.bleed .image-caption {
  border-radius: 0;
  max-width: none;
  margin: 0;
}
