...
<template>
  <div class="slidev-layout fenbrook-quote">
    <div class="bigmark" aria-hidden="true">&ldquo;</div>
    ...
    <div class="quote-stack">
      ...
      <div v-if="slots.attribution" class="attribution">
...
.bigmark {
  ...
  color: transparent;
  -webkit-text-stroke: 2px var(--fenbrook-accent);
  opacity: 0.35;
  pointer-events: none;
  user-select: none;
  z-index: 0;
...
.attribution-text :deep(*) {
  display: inline;
  margin: 0;
}

.attribution-text :deep(em) {
