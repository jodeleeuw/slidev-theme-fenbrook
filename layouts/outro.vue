...
<template>
  <div class="slidev-layout fenbrook-outro" :class="{ 'has-notes': slots.next }">
...
.outro-notes {
  border-left: 2px solid color-mix(in oklab, var(--fenbrook-accent) 45%, transparent);
  padding-left: 2rem;
}
