...
<template>
  <div ref="wrapper" class="fenbrook-fit" :class="`fenbrook-fit--${align}`">
    <div
      ref="inner"
      class="fenbrook-fit-inner"
...
.fenbrook-fit--top    { align-items: flex-start; }
.fenbrook-fit--center { align-items: center; }
.fenbrook-fit--bottom { align-items: flex-end; }
